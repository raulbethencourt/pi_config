...
import { resolveFallbackModel, loadRoutingConfig, type ComplexityTier } from "./routing.ts";
...
import { buildPiArgs } from "./build-args.ts";
...
const { fallback: FALLBACK_CONFIG } = loadRoutingConfig(path.dirname(AGENTS_DIR));
